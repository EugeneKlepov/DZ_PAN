...
int main() {
	...
	if ((h1 > h2) and (h1 > h3)) {
		cout << "Быстрее всех наберёт высоту 1-ый самолёт и его h=" << h1 << endl;
	}
	if ((h2 > h1) and (h2 > h3)) {
		cout << "Быстрее всех наберёт высоту 2-ой самолёт и его h=" << h2 << endl;
	}
	if ((h3 > h2) and (h3 > h1)) {
		cout << "Быстрее всех наберёт высоту 3-ий самолёт и его h=" << h3 << endl;
	}
