...
void output_plane(Aircraft* plane, int number) {
    cout << "Информация о " << number + 1 << " самолете"<<endl;
    cout << "Масса: " << plane->weight << endl;
    cout << "Площадь крыла: " << plane->S << endl;
    cout << "Тяга двигателя: " << plane->T << endl;
    cout << "Коэффициент подъемной силы: " << plane->C_l << endl;
    cout << "Коэффициент силы сопротивления: " << plane->C_d << endl;
    cout << "Подъемная сила: " << plane->L << endl;
    cout << "Сопротивление: " << plane->D << endl;
    cout << "Ускорение: " << plane->a;
}
